...
const SHOTS = [
  { name: 'cockpit-dark', hash: 'cockpit', w: 1440, h: 1000, scheme: 'dark' },
  { name: 'cockpit-light', hash: 'cockpit', w: 1440, h: 1000, scheme: 'light' },
  ...
  { name: 'cockpit-mobile', hash: 'cockpit', w: 390, h: 844, scheme: 'light', mobile: true },
  { name: 'news-mobile', hash: 'news', w: 390, h: 844, scheme: 'dark', mobile: true },
];
