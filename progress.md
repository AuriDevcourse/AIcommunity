...
## Latest session — 2026-06-05 (branch `feat/suggestions-to-forum`, not yet merged)
...
- **Tools** — free utilities: **Post maker** (session → LinkedIn/IG post via Gemini), **Token & cost estimator**, **Image to link** (ImgBB), **JSON formatter**.
...
- **Merge `feat/suggestions-to-forum` → `main`** to ship this session's work (Vercel auto-deploys main).
